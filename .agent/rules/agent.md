...
- Rust crates: `crates/gecko_*/`
- Error types: Each crate uses `thiserror`
- Audio thread: Zero allocation, lock-free (`rtrb`, atomics)
- Components: CVA variants, `forwardRef`, `gecko-*` tokens
